...
{
    Serial.println("Weather mcu open");
    int i = 0;
    char buffer[13] = {0};
...
void weather_open_return_handle(unsigned char res, unsigned char err)
{
    ...
    Serial.println("WEATHER OPEN HANDLE");
    Serial.println(res);
    if(res == 1) {
...
void weather_data_user_handle(char *name, unsigned char type, const unsigned char *data, char day)
{
  ...
  //First get the data type
    ...
    if(my_strcmp(name, "temp") == 0) {
        ...
        Serial.println(value_int);          //int type
        ...
        Serial.print("day:");
        Serial.println(day);
        Serial.print("pm25 value is:");
        Serial.println(value_int);          //int type
        //printf("day:%d pm25 value is:%d\r\n", day, value_int);          //int type
    }else if(my_strcmp(name, "condition") == 0) {
        Serial.print("day:");
        Serial.println(day);
        Serial.print("condition value is:");
        Serial.print(value_string);  //string type
